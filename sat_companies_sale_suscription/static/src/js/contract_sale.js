odoo.define('sat_companies_sale_suscription.javascript', ['web.ajax'], function(require){
  ...
  var id_sale_subscription = document.getElementById("id_value_subscription").textContent;
  ...
  (function() {
    ...
    submitBtn.addEventListener("click", function(e) {
      ...
      buttonSendDoc.onclick = function () {
          ...
          ajax.jsonRpc('/send_sale_subscription', 'call', {url_signature: dataUrl,
                                          id_sale_subscription: id_sale_subscription});
